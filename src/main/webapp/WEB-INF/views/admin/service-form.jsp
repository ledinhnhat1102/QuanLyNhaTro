...
<body>
                            ...
                            <form method="POST" id="serviceForm">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               required 
                                               maxlength="100">
                                        <div class="form-text">Tên dịch vụ phải là duy nhất</div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3 position-relative">
                                        ...
                                        <input type="text" 
                                               ...
                                               maxlength="50"
                                               autocomplete="off">
                                        <div class="form-text">Để trống nếu không có đơn vị</div>
                                        
                                        <!-- Unit suggestions -->
                                        <div id="unitSuggestions" class="unit-suggestions">
                                            <div class="unit-suggestion" data-unit="kWh">kWh (Điện)</div>
                                            <div class="unit-suggestion" data-unit="m³">m³ (Nước)</div>
                                            <div class="unit-suggestion" data-unit="tháng">tháng (Internet, Cáp)</div>
                                            <div class="unit-suggestion" data-unit="người">người (Dịch vụ)</div>
                                            <div class="unit-suggestion" data-unit="lần">lần (Vệ sinh)</div>
                                            <div class="unit-suggestion" data-unit="tháng">tháng (Bảo trì)</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="pricePerUnit" class="form-label">
                                        ...
                                        Giá mỗi đơn vị (VNĐ) <span class="required">*</span>
                                    </label>
                                    <input type="number" 
                                           class="form-control" 
                                           id="pricePerUnit" 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card border-light">
                                                <div class="card-body py-2">
                                                    <small>
                                                        <strong>Điện:</strong> kWh - 3,500₫<br>
                                                        <strong>Nước:</strong> m³ - 25,000₫<br>
                                                        <strong>Internet:</strong> tháng - 100,000₫
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="card border-light">
                                                <div class="card-body py-2">
                                                    <small>
                                                        <strong>Vệ sinh:</strong> tháng - 50,000₫<br>
                                                        <strong>Bảo trì:</strong> tháng - 30,000₫<br>
                                                        <strong>Gửi xe:</strong> tháng - 20,000₫
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        // Unit suggestions functionality
        ...
        document.querySelectorAll('.unit-suggestion').forEach(suggestion => {
        ...
        unitInput.addEventListener('input', function() {
            ...
            const suggestions = document.querySelectorAll('.unit-suggestion');
        ...
        // Format price input (remove non-digits)
        document.getElementById('pricePerUnit').addEventListener('input', function(e) {
