            ...
            <div class="col-md-9 col-lg-10 main-content">
                ...
                <div class="p-4">
                    ...
                    <div class="mb-3">
                        <c:choose>
                            <c:when test="${isAdmin}">
                                <a href="${pageContext.request.contextPath}/admin/messages" class="btn btn-outline-primary">
                                            ...
                                            <div class="col-lg-6 col-xl-4 mb-3">
                                                <div class="recipient-item" onclick="selectRecipient(${recipient.userId}, '${recipient.fullName}')">
                                                    <div class="d-flex align-items-center">
                                                        <div class="recipient-avatar ${recipient.role == 'ADMIN' ? 'admin-avatar' : ''}">
                                                            ${recipient.fullName.substring(0, 1).toUpperCase()}
                                                        </div>
                                                        <div class="ms-3">
                                                            <div class="fw-bold">${recipient.fullName}</div>
                                                            <small class="text-muted">
                                                                <i class="bi bi-person me-1"></i>@${recipient.username}
                                                                <span class="role-badge ${recipient.role == 'ADMIN' ? 'role-admin' : 'role-user'} ms-1">
                                                                    ${recipient.role == 'ADMIN' ? 'Quản trị viên' : 'Người dùng'}
                                                                </span>
                                                            </small>
